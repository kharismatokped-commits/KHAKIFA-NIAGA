      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Daftar toko dan pembeli kulakan yang dikelompokkan otomatis
            berdasarkan riwayat transaksi WhatsApp.
          </p>
        </div>
        <button
                  ...
                  >
                    ...
                    >
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-50 text-primary hover:bg-emerald-100 font-semibold text-[11px] transition-colors"
                      >
                    ...
                    <td className="px-5 py-3.5 text-right">
                      <button
                        type="button"
                        onClick={() => setSelectedCustomer(c)}
                        className="px-2.5 py-1 rounded-lg bg-gray-100 hover:bg-primary hover:text-white text-gray-700 text-[11px] font-semibold transition-all inline-flex items-center gap-1 cursor-pointer"
                      >
                        <span>Lihat</span>
            ...
            <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-10 rounded-t-2xl">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  PIC: {selectedCustomer.namaPemesan} •{" "}
                  {selectedCustomer.noWhatsApp}
                </p>
              </div>
              <button
            ...
            <div className="p-6 space-y-6 overflow-y-auto flex-1 text-xs">
              ...
              <div>
                <h4 className="font-bold text-gray-900 mb-2 flex items-center justify-between">
                  <span>
                    Riwayat Semua Pesanan ({selectedCustomer.orders.length}):
                  </span>
                  <a
                        ...
                        >
                          ...
                          <td className="px-3 py-2.5 text-right">
                            <Link
                              ...
                              className="inline-flex items-center gap-1 px-2 py-1 rounded bg-gray-100 hover:bg-primary hover:text-white font-semibold text-[11px] transition-colors"
                            >
                              <span>Buka</span>
